...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/20 14:35:32 by tmaske            #+#    #+#             */
/*   Updated: 2017/11/29 11:09:29 by hmthimun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

void	endl_count(char *buff, t_li **li)
{
	t_li *lj;
...
void	mvr(char ***line, char **temp, t_li *li)
{
	endl_count(*temp, &li);
	if (li->cnt == -1)
	{
...
void	rdr(const int fd, t_li *li, char **temp)
{
